...
interface FSNClaimPopupProps {
  isOpen: boolean;
  onClose: () => void;
}

const FSNClaimPopup: React.FC<FSNClaimPopupProps> = ({ isOpen, onClose }) => {
  ...
  const handleKeyPress = (e: React.KeyboardEvent) => {
    if (e.key === 'Enter' && fsnInput && availabilityStatus?.available && !isChecking) {
    ...
    <div className="fsn-claim-popup-overlay" onClick={handleClose}>
      <div className="fsn-claim-popup" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="fsn-claim-popup-content">
          ...
          {/* Availability Status */}
          {fsnInput && fsnInput.length >= 3 && fsnInput.length <= 20 && (
          ...
          <div className="fsn-buttons">
            <button
              ...
              disabled={!fsnInput || fsnInput.length < 3 || fsnInput.length > 20 || !availabilityStatus?.available || isChecking}
