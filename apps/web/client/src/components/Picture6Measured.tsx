...
interface Picture6MeasuredProps {
  xpPoints?: number;
  onXPUpdate?: () => void;
}

export default function Picture6Measured({ xpPoints = 50, onXPUpdate }: Picture6MeasuredProps) {
  ...
  return (
    <div style={{
      ...
      gridTemplateRows: '15fr 20fr 30fr 20fr 15fr',
      gridTemplateAreas: `
        "left-top upload"
        "fsn-circle vault-files"
        "fsn-circle sentinel-progress"
        "sentinel-badge debug-panel"
        "left-bottom debug-panel"
      `,
      height: '100vh',
