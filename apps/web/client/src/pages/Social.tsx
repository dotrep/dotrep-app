        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{
              ...
              animation: 'network-pulse 2s ease-in-out infinite alternate'
            }} />
          </div>
          ...
          <h1 style={{
            ...
            animation: 'social-glow 3s ease-in-out infinite alternate'
          }}>
            🌐 FSN NETWORK
          </h1>
          ...
          <div style={{
            ...
            Connect with other FSN identities across the network
          </div>
          ...
          <div style={{
            ...
            <div className="social-card" style={{
              ...
              <div style={{ color: 'rgba(255,255,255,0.7)', fontSize: '14px' }}>
                Discover and connect with FSN users
              </div>
            </div>
            ...
            <div className="social-card" style={{
              ...
              <div style={{ color: 'rgba(255,255,255,0.7)', fontSize: '14px' }}>
                Showcase your badges and progress
              </div>
            </div>
          </div>
          ...
          <div style={{
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '15px' }}>
              {[
                { user: 'satoshi.fsn', action: 'earned Core Signal badge', time: '2m ago', icon: '🎖️' },
                { user: 'vitalik.fsn', action: 'uploaded encrypted file', time: '5m ago', icon: '🔐' },
                { user: 'alice.fsn', action: 'completed Signal Challenge', time: '8m ago', icon: '⚡' },
                { user: 'bob.fsn', action: 'joined the network', time: '12m ago', icon: '🌐' },
                { user: 'charlie.fsn', action: 'earned Trust Verified badge', time: '18m ago', icon: '🛡️' }
              ].map((activity, index) => (
                <div key={index} style={{
                  display: 'flex',
                  alignItems: 'center',
                ...
                >
                  <div style={{ fontSize: '20px', marginRight: '15px' }}>{activity.icon}</div>
                  <div style={{ flex: 1 }}>
                    <div style={{ 
                      color: '#00bcd4', 
                      fontWeight: '500',
          ...
          <div style={{
            ...
            <div style={{ 
              ...
              SOCIAL FEATURES EXPANDING
            </div>
            <div style={{ 
              color: 'rgba(255,255,255,0.7)', 
              fontSize: '16px' 
            }}>
              Advanced social networking features are being developed for the FSN community
            </div>
          </div>
        </div>
